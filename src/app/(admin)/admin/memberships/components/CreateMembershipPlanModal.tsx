    ...
    if (initialData) {
      setFormData({
        ...
        perks: initialData.perks.map((perk) => ({
          ...
          maxPerMonth: perk.maxPerMonth || undefined, // ✅ Added
            ...
            <div className="space-y-4">
              {formData.perks.map((perk, index) => (
                ...
                >
                  ...
                  {/* Advanced Settings */}
                  <div className="pt-3 border-t border-gray-200/60 grid grid-cols-1 md:grid-cols-3 gap-4">
                    {/* ✅ Max Per Day */}
                    <div>
                      <label className="block text-xs font-semibold text-gray-500 mb-1">
                        Max Per Day
