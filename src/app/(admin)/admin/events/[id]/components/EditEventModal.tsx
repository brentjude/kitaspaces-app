  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const updateData = {
        ...
        date: new Date(`${formData.date}T${formData.startTime || '00:00'}`).toISOString(),
        ...
        ...(!hasPaidRegistrations && {
          ...
          redemptionLimit: formData.isRedemptionEvent ? formData.redemptionLimit : null,
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="p-6 space-y-6 max-h-[calc(100vh-200px)] overflow-y-auto">
            ...
            <div className="flex gap-3">
              ...
              <div className="text-sm text-orange-800">
                ...
                <p>
                  ...
                  description, date, time, location, and category. Price and freebies cannot
                  be modified.
                </p>
              </div>
            </div>
        ...
        {/* Price and Settings (Only if no paid registrations) */}
        {!hasPaidRegistrations && (
          <>
